...
export function Navigation() {
  ...
  return <header className="navigation"><a className="skip-link" href="#main">Skip to content</a><div className="container nav-inner">
    ...
    <nav aria-label="Main navigation" id="main-navigation" className={open ? 'nav-links is-open' : 'nav-links'}>
      <a href="#solutions" onClick={()=>setOpen(false)}>Solutions</a><a href="#industries" onClick={()=>setOpen(false)}>Industries</a><a href="#privacy" onClick={()=>setOpen(false)}>Why Blinking</a><a href="https://www.blinking.id/blog/">Insights <ArrowUpRight size={12}/></a>
    </nav>
