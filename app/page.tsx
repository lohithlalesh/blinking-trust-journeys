...
export default function Home() {
  return <>
    ...
    <main id="main">
      ...
      <section id="journey" className="intro container"><h2>Every great journey<br/>starts with trust.</h2><p>From the first document to the final decision, connect your identity checks in one configurable flow.</p></section>
      <ScrollJourney />
      <section className="solutions container" id="solutions">
        ...
        <div className="product-grid">
          ...
          <div className="product-side">
            <article className="product-video" data-reveal><Video size={27} strokeWidth={1.5}/><h3>A human touch.<br/>When it matters.</h3><p>Bring an agent into the journey with real-time video identification and manual ID comparison.</p><a className="text-link" href="https://www.blinking.id/solutions/identify/">Explore video identification <ArrowUpRight size={17}/></a></article>
            <article className="product-config" data-reveal><Layers3 size={26} strokeWidth={1.5}/><div><h3>Built to fit. Ready to adapt.</h3><p>Configure your flow, collect the right data, and manage due diligence in one place.</p><a className="text-link" href="https://www.blinking.id/plans/">Find your fit <ArrowUpRight size={17}/></a></div></article>
          </div>
        </div>
